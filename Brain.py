...
class PreNet(nn.Module):
    def __init__(self, h, w):
        ...
        self.conv1_1 = nn.LazyConv2d(64, 3, padding=1)
        self.conv1_2 = nn.LazyConv2d(64, 5, padding=2)
        self.conv1_3 = nn.LazyConv2d(64, 7, padding=3)
        self.conv1_4 = nn.LazyConv2d(64, 9, padding=4)
